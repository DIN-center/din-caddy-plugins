...
//
// Solidity: function getNetworkOperationsConfig(string networkName) view returns((string,uint8,uint8,uint16,uint8,uint8,uint8,uint16,uint32,bool,uint16,uint16,string) opsConfig)
...
// CreateNetwork is a paid mutator transaction binding the contract method 0x9af0977f.
//
// Solidity: function createNetwork(string name, string description, (string,uint8,uint8,uint16,uint8,uint8,uint8,uint16,uint32,bool,uint16,uint16,string) config, uint8 initialStatus) returns(address newNetwork)
...
// SetNetworkOperationsConfig is a paid mutator transaction binding the contract method 0x5776a86f.
//
// Solidity: function setNetworkOperationsConfig(string networkName, (string,uint8,uint8,uint16,uint8,uint8,uint8,uint16,uint32,bool,uint16,uint16,string) _opsConfig) returns()
