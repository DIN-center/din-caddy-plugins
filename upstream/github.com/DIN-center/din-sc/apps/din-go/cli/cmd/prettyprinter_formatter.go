...
func (h *PrettyPrinterFormatter) formatNetworkFull(network *din.Network, options FormatOptions) error {
	...
	if network.NetworkConfig != nil {
		...
		l.AppendItem("Handler: " + network.NetworkConfig.Handler)
		...
		l.AppendItem("HealthcheckThreshold: " + fmt.Sprintf("%d", network.NetworkConfig.HealthcheckThreshold))
		l.AppendItem("HealthcheckTimeout: " + fmt.Sprintf("%d", network.NetworkConfig.HealthcheckTimeout))
		...
		l.AppendItem("ProviderBlockHistorySize: " + fmt.Sprintf("%d", network.NetworkConfig.ProviderBlockHistorySize))
		l.AppendItem("NetworkBlockHistorySize: " + fmt.Sprintf("%d", network.NetworkConfig.NetworkBlockHistorySize))
