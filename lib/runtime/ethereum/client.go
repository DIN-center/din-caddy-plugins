...
func (e *EthereumClient) GetLatestBlockNumber(hcRPCMethod string, httpUrl string, headers map[string]string) (int64, int, error) {
	payload := []byte(`{"jsonrpc":"2.0","method":"` + hcRPCMethod + `","params":[],"id":1}`)
