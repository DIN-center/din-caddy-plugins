...
type EthereumRuntimeClient struct {
	HTTPClient *http.HTTPClient
}

func NewEthereumRuntimeClient() *EthereumRuntimeClient {
	return &EthereumRuntimeClient{
		HTTPClient: http.NewHTTPClient(),
	}
}

func (e *EthereumRuntimeClient) GetLatestBlock(url string) (*int64, error) {
