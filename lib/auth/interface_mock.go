...
func (m *MockIAuthClient) GetToken(arg0 map[string]any) (AuthToken, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIAuthClientMockRecorder) GetToken(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIAuthClientMockRecorder) Sign(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockIAuthClientMockRecorder) Start(arg0 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
